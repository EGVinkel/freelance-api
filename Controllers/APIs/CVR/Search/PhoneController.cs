...
{
    [Route("api/cvr/search/phone")]
    [ApiController]
    public class PhoneController : ControllerBase
    {
        [HttpPost("{phoneFromEndPoint}")]
        [AllowAnonymous]
        public async Task<IActionResult> PostAsync(string phoneFromEndPoint)
        {
            int responseStatusCode;
            var responseFromHttpRequest = await CVRPhoneHTTPRequestAsync(phoneFromEndPoint);
        ...
        protected async Task<HttpResponseMessage> CVRPhoneHTTPRequestAsync(string phoneFromEndPoint)
        {
            ...
            parameters.Add("phone", phoneFromEndPoint);
